...
- **Dice System**: Base, Dread, and Gear dice with distinct outcomes -- clean success, tainted success, dire failure
- **Push Mechanic**: Re-roll for another chance, but 1s carry consequences
- **Omen Pool**: GM resource generated by player failures and pushed Dread dice
